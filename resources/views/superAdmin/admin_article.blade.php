...
@if($errors->any())
      ...
      <!-- page-content" -->
      <div class="container">
          <h2 class="text-center mt-5">Post an article</h2>
          <hr>
          <!------------------------------- Post Artcile ------------------------------->

          <!------------------------------- Start Of Form ------------------------------->
          <form method="POST" action="{{route('post_admin_article')}}" class="ValidationForm" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row">
            <!-- article_type_id -->
