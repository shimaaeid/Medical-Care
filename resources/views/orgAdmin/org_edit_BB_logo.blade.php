...
@section('title','Edit BB Logo Image')
@section('styles')
...
@section('content')
      ...
      <!-- page-content" -->
      <div class="container">
          <h2 class="text-center">Edit Blood Bank Logo Image</h2>
          <hr>
          <!------------------------------- Edit Department ------------------------------->

          <!------------------------------- Start Of Form ------------------------------->
          <form method="POST" action="{{route('editBBLogoImage')}}" class="ValidationForm" enctype="multipart/form-data" novalidate>
            @csrf
