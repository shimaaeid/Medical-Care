...
<div class="container">
    <h2 class="text-center text-muted">Organization Admin</h2>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Organization Admin Login</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('o_authenticate_login') }}">
                        @csrf
