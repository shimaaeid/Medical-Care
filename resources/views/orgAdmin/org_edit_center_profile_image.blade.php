...
@section('title','Edit Center Profile Image')
@section('styles')
...
@section('content')
      ...
      <!-- page-content" -->
      <div class="container">
          <h2 class="text-center">Edit Center Profile Image</h2>
          <hr>
          <!------------------------------- Edit Department ------------------------------->

          <!------------------------------- Start Of Form ------------------------------->
          <form method="POST" action="{{route('editCenterProfileImage')}}" class="ValidationForm" enctype="multipart/form-data" novalidate>
            @csrf
