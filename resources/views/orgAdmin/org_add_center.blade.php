...
@section('content')
      ...
      <div class="container">
          ...
          <!------------------------------- Start Of Form ------------------------------->
          <form method="POST" action="{{route('addCenter')}}" class="ValidationForm" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row">
              <!------------------------------- Laboratory Name ------------------------------->
              <div class=" col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="form-group input-group">
                  ...
                  <input name="laboratory_name" class="name form-control" placeholder="* Center name" type="text">
                </div> <!-- form-group Name -->
