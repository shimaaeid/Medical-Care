...
@section('title','Edit Lab Profile Image')
@section('styles')
...
@section('content')
      ...
      <!-- page-content" -->
      <div class="container">
          <h2 class="text-center">Edit Lab Profile Image</h2>
          <hr>
          <!------------------------------- Edit Department ------------------------------->

          <!------------------------------- Start Of Form ------------------------------->
          <form method="POST" action="{{route('editLabProfileImage')}}" class="ValidationForm" enctype="multipart/form-data" novalidate>
            @csrf
