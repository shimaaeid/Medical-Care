...
@section('content')
          ...
          @isset($result)
            @if($result != 'false')
              <div class="alert alert-success">
                New Laboratory: <b> ( {{ $result }} ) </b> added
              </div>
            @endif
          @endisset
        @endif
      ...
      <!-- page-content" -->
      <div class="container">
          <h2 class="text-center">Add Laboratory</h2>
          <hr>
          <!------------------------------- Add Laboratory ------------------------------->

          <!------------------------------- Start Of Form ------------------------------->
          <form method="POST" action="{{route('addLaboratory')}}" class="ValidationForm" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row">
              <!------------------------------- Laboratory Name ------------------------------->
              <div class=" col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="form-group input-group">
                  ...
                  <input name="laboratory_name" class="name form-control" placeholder="* Laboratory name" type="text">
                </div> <!-- form-group Name -->
              ...
              <div class=" col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="form-group input-group">
                  ...
                  <input name="laboratory_email" class="email form-control" placeholder="* Email" type="email">
                </div> <!-- form-group Name -->
                <div class="alert alert-danger custom-alert">
              ...
              <div class=" col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="custom-file mb-3">
                  <input type="file" class="imageprofile custom-file-input" id="laboratory_profileImage" name="laboratory_profileImage">
                  <label class="custom-file-label" for="laboratory_profileImage">* Profile Image</label>
                </div>
                <div class="alert alert-danger custom-alert">
              ...
              <div class=" col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="custom-file mb-3">
                  <input type="file" class="imagelogo custom-file-input" id="laboratory_lgogImage" name="laboratory_logogImage">
                  <label class="custom-file-label" for="laboratory_lgogImage">* Logo Image</label>
                </div>
                <div class="alert alert-danger custom-alert">
              ...
              <div class=" col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="form-group input-group">
                  ...
                  <input name="laboratory_website" class="url form-control" placeholder="Website" type="url">
                </div>
                <div class="alert alert-danger custom-alert">
              ...
              <div class=" col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="form-group input-group">
                  ...
                  <input name="laboratory_facebook" class="url-facebook form-control" placeholder="Facebook" type="url">
                </div>
                <div class="alert alert-danger custom-alert">
              ...
              <div class=" col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="form-group input-group">
                  ...
                  <input name="laboratory_twitter" class="url-twitter form-control" placeholder="Twitter" type="url">
                </div>
                <div class="alert alert-danger custom-alert">
              ...
              <div class=" col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="form-group input-group">
                  ...
                  <input name="laboratory_instagram" class="url-instagram form-control" placeholder="Instagram" type="url">
                </div>
                <div class="alert alert-danger custom-alert">
              ...
              <div class=" col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="form-group input-group">
                  ...
                  <input name="laboratory_youtube" class="url-youtube form-control" placeholder="Youtube" type="url">
                </div>
                <div class="alert alert-danger custom-alert">
              ...
              <div class=" col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="form-group input-group">
                  ...
                  <input name="laboratory_map" class="url-GoogleMap form-control" placeholder="Google Map" type="url">
                </div>
                <div class="alert alert-danger custom-alert">
