...
@section('title','Add Center Radition')
@section('styles')
@endsection
...
@section('content')
      ...
      <!-- page-content" -->
      <div class="container">
          <h2 class="text-center">Add Center Radition</h2>
          <hr>
          <!------------------------------- Add Laboratory ------------------------------->

          <!------------------------------- Start Of Form ------------------------------->
          <form method="POST" action="{{route('addRadition')}}" class="ValidationForm" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row">
              <!-------------------------------  Analysis  ------------------------------->
              <div class="col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="form-group">
                  <select class="custom-select selected-governorate" name="analysis_id">
                    <option selected disabled value="">Radition</option>
