...
@section('content')
      ...
      <div class="container">
          ...
          <!------------------------------- Start Of Form ------------------------------->
          <form method="post" action="{{route('editLaboratory')}}" class="ValidationForm" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row">
              <!------------------------------- User Name ------------------------------->
              <div class=" col-md-6 offset-md-0 col-sm-8 offset-sm-2">
                <div class="form-group input-group">
                  ...
                  <input name="laboratory_name" class="name form-control" placeholder="laboratory name" type="text" value="{{$all_laboratory_data[0] -> name}}">
                </div> <!-- form-group Name -->
              ...
              @isset($all_laboratory_data)<input type="hidden" name="social_id" value="{{$all_laboratory_data[0]->social_link_id}}">@endisset
                <div class="row justify-content-between col-12">
                  <div class="form-group col-md-4 d-flex">
                    ...
                    <a href="{{route('showeditLabLogoImage',['id' => $laboratory_id ])}}"  style="line-height: 35px">&nbsp;&nbsp;Edit Logo Image</a>
                  </div>
                  ...
                  <div class="form-group col-md-4 d-flex justify-content-end">
                    <i class="fas fa-image text-primary"  style="font-size: 35px"></i>
                    <a href="{{route('showeditLabProfileImage',['id' => $laboratory_id ])}}" style="line-height: 35px">&nbsp;&nbsp;Edit Profile Image</a>
                  </div>
                </div>
              </div>
  ...
  @section('scripts')
  <script src="{{ url('/orgAdmin/js/laboratoryValidation_update.js') }}"></script>
