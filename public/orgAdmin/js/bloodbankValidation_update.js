$(function() {
    ...
    var formErrors = ['.name', '.email', '.address', '.selected-phone-code', '.phone-number', '.url', '.url-facebook', '.url-twitter', '.url-instagram', '.url-youtube', '.url-GoogleMap', '.selected-governorate', '.selected-city', '.about_us',
        '.blood_type_O-', '.blood_type_O_plus', '.blood_type_A-', '.blood_type_A_plus', '.blood_type_B-', '.blood_type_B_plus', '.blood_type_AB-', '.blood_type_AB_plus'
    ];
    var regExpValidation = {
        "nameMinMaxLength": /^.{4,100}$/,
        "name": /^[a-zA-Z][\w_\-\s\d]{3,99}$/,
    ...
    /*------------------------------- Blood type cases O- -------------------------------*/
    $('.blood_type_O-').change(function() {
        if ($(this).val() != "") {
            $(this).removeClass('is-invalid').addClass('is-valid').parent().parent().find('.custom-alert').fadeOut(250);
            $(this).css("border-color", "#28a745");
            // Remove blood_type_O- Errors Array
            if (formErrors.includes(".blood_type_O-"))
                removeSpecificElement(formErrors, '.blood_type_O-');
        } else {
            $(this).removeClass('is-valid').addClass('is-invalid').parent().parent().find('.custom-alert').fadeIn(500);
            $(this).css("border-color", "#dc3545");
            // Add blood_type_O- to Errors Array
            if (!formErrors.includes(".blood_type_O-"))
                formErrors.push('.blood_type_O-');
        }
    ...
    /*------------------------------- Blood type cases O_plus -------------------------------*/
    $('.blood_type_O_plus').change(function() {
        if ($(this).val() != "") {
            $(this).removeClass('is-invalid').addClass('is-valid').parent().parent().find('.custom-alert').fadeOut(250);
            $(this).css("border-color", "#28a745");
            // Remove blood_type_O_plus Errors Array
            if (formErrors.includes(".blood_type_O_plus"))
                removeSpecificElement(formErrors, '.blood_type_O_plus');
        } else {
            $(this).removeClass('is-valid').addClass('is-invalid').parent().parent().find('.custom-alert').fadeIn(500);
            $(this).css("border-color", "#dc3545");
            // Add blood_type_O_plus to Errors Array
            if (!formErrors.includes(".blood_type_O_plus"))
                formErrors.push('.blood_type_O_plus');
        }
    ...
    /*------------------------------- Blood type cases A- -------------------------------*/
    $('.blood_type_A-').change(function() {
        if ($(this).val() != "") {
            $(this).removeClass('is-invalid').addClass('is-valid').parent().parent().find('.custom-alert').fadeOut(250);
            $(this).css("border-color", "#28a745");
            // Remove blood_type_A- Errors Array
            if (formErrors.includes(".blood_type_A-"))
                removeSpecificElement(formErrors, '.blood_type_A-');
        } else {
            $(this).removeClass('is-valid').addClass('is-invalid').parent().parent().find('.custom-alert').fadeIn(500);
            $(this).css("border-color", "#dc3545");
            // Add blood_type_A- to Errors Array
            if (!formErrors.includes(".blood_type_A-"))
                formErrors.push('.blood_type_A-');
        }
    ...
    /*------------------------------- Blood type cases A_plus -------------------------------*/
    $('.blood_type_A_plus').change(function() {
        if ($(this).val() != "") {
            $(this).removeClass('is-invalid').addClass('is-valid').parent().parent().find('.custom-alert').fadeOut(250);
            $(this).css("border-color", "#28a745");
            // Remove blood_type_A_plus Errors Array
            if (formErrors.includes(".blood_type_A_plus"))
                removeSpecificElement(formErrors, '.blood_type_A_plus');
        } else {
            $(this).removeClass('is-valid').addClass('is-invalid').parent().parent().find('.custom-alert').fadeIn(500);
            $(this).css("border-color", "#dc3545");
            // Add blood_type_A_plus to Errors Array
            if (!formErrors.includes(".blood_type_A_plus"))
                formErrors.push('.blood_type_A_plus');
        }
    ...
    /*------------------------------- Blood type cases B- -------------------------------*/
    $('.blood_type_B-').change(function() {
        if ($(this).val() != "") {
            $(this).removeClass('is-invalid').addClass('is-valid').parent().parent().find('.custom-alert').fadeOut(250);
            $(this).css("border-color", "#28a745");
            // Remove blood_type_B- Errors Array
            if (formErrors.includes(".blood_type_B-"))
                removeSpecificElement(formErrors, '.blood_type_B-');
        } else {
            $(this).removeClass('is-valid').addClass('is-invalid').parent().parent().find('.custom-alert').fadeIn(500);
            $(this).css("border-color", "#dc3545");
            // Add blood_type_B- to Errors Array
            if (!formErrors.includes(".blood_type_B-"))
                formErrors.push('.blood_type_B-');
        }
    ...
    /*------------------------------- Blood type cases B_plus -------------------------------*/
    $('.blood_type_B_plus').change(function() {
        if ($(this).val() != "") {
            $(this).removeClass('is-invalid').addClass('is-valid').parent().parent().find('.custom-alert').fadeOut(250);
            $(this).css("border-color", "#28a745");
            // Remove blood_type_B_plus Errors Array
            if (formErrors.includes(".blood_type_B_plus"))
                removeSpecificElement(formErrors, '.blood_type_B_plus');
        } else {
            $(this).removeClass('is-valid').addClass('is-invalid').parent().parent().find('.custom-alert').fadeIn(500);
            $(this).css("border-color", "#dc3545");
            // Add blood_type_B_plus to Errors Array
            if (!formErrors.includes(".blood_type_B_plus"))
                formErrors.push('.blood_type_B_plus');
        }
    ...
    /*------------------------------- Blood type cases AB- -------------------------------*/
    $('.blood_type_AB-').change(function() {
        if ($(this).val() != "") {
            $(this).removeClass('is-invalid').addClass('is-valid').parent().parent().find('.custom-alert').fadeOut(250);
            $(this).css("border-color", "#28a745");
            // Remove blood_type_AB- Errors Array
            if (formErrors.includes(".blood_type_AB-"))
                removeSpecificElement(formErrors, '.blood_type_AB-');
        } else {
            $(this).removeClass('is-valid').addClass('is-invalid').parent().parent().find('.custom-alert').fadeIn(500);
            $(this).css("border-color", "#dc3545");
            // Add blood_type_AB- to Errors Array
            if (!formErrors.includes(".blood_type_AB-"))
                formErrors.push('.blood_type_AB-');
        }
    ...
    /*------------------------------- Blood type cases AB_plus -------------------------------*/
    $('.blood_type_AB_plus').change(function() {
        if ($(this).val() != "") {
            $(this).removeClass('is-invalid').addClass('is-valid').parent().parent().find('.custom-alert').fadeOut(250);
            $(this).css("border-color", "#28a745");
            // Remove blood_type_AB_plus Errors Array
            if (formErrors.includes(".blood_type_AB_plus"))
                removeSpecificElement(formErrors, '.blood_type_AB_plus');
        } else {
            $(this).removeClass('is-valid').addClass('is-invalid').parent().parent().find('.custom-alert').fadeIn(500);
            $(this).css("border-color", "#dc3545");
            // Add blood_type_AB_plus to Errors Array
            if (!formErrors.includes(".blood_type_AB_plus"))
                formErrors.push('.blood_type_AB_plus');
        }
    ...
    $('.ValidationForm').submit(function(e) {
        if (
            ...
            $('.selected-city,.selected-governorate, .selected-phone-code, .blood_type_O-, .blood_type_O_plus, .blood_type_A-, .blood_type_A_plus, .blood_type_B-, .blood_type_B_plus, .blood_type_AB-, .blood_type_AB_plus ').change(); // To Show Error for Image has event is change and have Error 
        }
